GUÍA DE PERFILES ACADÉMICOS Y PROFESIONALES
Dr. Alejandro Jasinski
Textos listos para copiar y pegar · Instrucciones paso a paso
Febrero 2026
Contenidos de esta guía
	•	1. Google Scholar — configuración y carga de publicaciones
	•	2. ORCID — completar perfil y vincular publicaciones
...

1. GOOGLE SCHOLAR
Ya tenés perfil creado. El objetivo es completarlo y asegurarse de que todas las publicaciones estén correctamente vinculadas.

1.1 Crear o completar el perfil
Pasos:
	•	Ir a: https://scholar.google.com — hacer clic en 'Mi perfil' (arriba a la derecha). Iniciar sesión con la cuenta Gmail asociada al perfil.
	•	Iniciar sesión con una cuenta de Gmail. Si no tenés una asociada a UBA, podés usar tu cuenta personal.
	•	Completar los campos del perfil con los textos de abajo.

Nombre (copiar tal cual):
Alejandro Jasinski

Afiliación (copiar tal cual):
Universidad de Buenos Aires (UBA) / Secretaría de Derechos Humanos de la Nación

Email de verificación:
alejandro.jasinski@gmail.com

Área de interés — palabras clave (copiar y pegar una por una en el campo):
Historia social latinoamericana; Violencia empresarial; Represión estatal; Derechos humanos; Movimiento obrero; Historia reciente Argentina

1.2 Agregar publicaciones
Pasos:
	•	En tu perfil, hacer clic en el botón '+' (Agregar artículos).
	•	Google Scholar habrá indexado automáticamente varias de tus publicaciones. Buscar por nombre y confirmar cuáles son tuyas.
	•	Para publicaciones que no aparezcan automáticamente, usar 'Agregar artículo manualmente'.

💡 Buscar: 'Jasinski Forestal', 'Jasinski Napalpí', 'Jasinski responsabilidad empresarial'. Verificar que el nombre del autor figure exactamente igual en todas las entradas.

1.3 Foto de perfil
Subir una foto profesional. Google Scholar no requiere foto académica formal — puede ser una foto de presentación pública.


2. ORCID
ORCID (Open Researcher and Contributor ID) es el identificador único internacional para investigadores. Ya tenés uno asignado: 0009-0004-1133-9429. Hay que completar el perfil.

2.1 Acceder y completar
	•	Ir a: https://orcid.org/0009-0004-1133-9429
	•	Hacer clic en 'Sign in' y acceder con el email de registro.
	•	Completar los campos como se indica abajo.

Nombre (copiar tal cual):
Alejandro Jasinski

Biografía / Also known as:
Dr. Alejandro Jasinski

URL de tu perfil:
https://orcid.org/0009-0004-1133-9429

2.2 Agregar afiliaciones
	•	En la sección 'Employment' (Empleo), agregar:
Secretaría de Derechos Humanos de la Nación — Investigador — 2013-2025
Universidad de Buenos Aires — Docente — 2011-presente
Universidad de Konstanz — Investigador Visitante — enero-febrero 2026

	•	En la sección 'Education' (Educación), agregar:
Doctorado en Historia — Universidad de Buenos Aires — 2013-2021
Licenciatura en Historia — Universidad de Buenos Aires — 2004-2011

2.3 Agregar publicaciones
	•	Ir a la sección 'Works' y hacer clic en '+ Add works'.
	•	Usar 'Search & link' → Conectar con CrossRef o DataCite para importar automáticamente.
	•	Buscar por nombre del autor y confirmar las publicaciones.
💡 El ISBN de El encanto del tanino es 978-987-697-220-1. El de Revuelta obrera es 978-987-691-157-5. Útiles para la búsqueda manual.


3. ACADEMIA.EDU
Ya tenés perfil en: https://independent.academia.edu/JasinskiAlejandro — hay que completarlo y subir trabajos.

3.1 Completar el perfil
	•	Iniciar sesión en https://www.academia.edu
	•	Ir a 'Edit Profile' y completar los campos como se indica.

Nombre:
Alejandro Jasinski

Afiliación principal (Primary Affiliation):
...
Violencia empresarial y responsabilidad corporativa
Represión estatal y terrorismo de Estado
Derechos humanos e historia reciente
Movimiento obrero y conflictividad laboral
La Forestal y la región del Chaco santafesino
Masacre de Napalpí y pueblos indígenas
Juicios de lesa humanidad en Argentina
Historia oral
Historia económica y empresarial

3.2 Subir trabajos
	•	Hacer clic en 'Upload Paper' para subir PDFs de tus artículos académicos.
	•	Prioridad: artículos de revistas (Contenciosa, Cuadernos de Marte, Estudios del Trabajo, Folia Histórica).
	•	También podés subir capítulos de libros y ponencias de congresos relevantes.
💡 No subir libros completos si tienen copyright editorial. Podés subir introducción o capítulo con nota indicando la referencia completa.


4. RESEARCHGATE
Ya tenés perfil creado. El objetivo es completarlo y subir publicaciones.

4.1 Completar el perfil
	•	Iniciar sesión en: https://www.researchgate.net con el email con el que te registraste.
	•	Ir a 'Edit profile' para actualizar los campos como se indica.
	•	Verificar que las publicaciones detectadas automáticamente sean correctas.
...
4.2 Agregar publicaciones y skills
	...
	•	En 'Skills & Expertise', agregar las palabras clave del campo de investigación.
	•	Seguir a investigadores del área (Basualdo, Franco, Bohoslavsky, Schneider) para aumentar visibilidad.
💡 ResearchGate envía estadísticas semanales de quién lee tus trabajos. Útil para saber qué publicaciones tienen más impacto.


5. LINKEDIN
Ya tenés perfil creado. Audiencias objetivo: academia internacional, organismos de DDHH y Estado, periodismo y medios, editoriales y cultura. El perfil debe hablar a todos estos actores a la vez, con un tono que combine la rigurosidad académica con la proyección pública.

5.1 Actualizar el perfil existente
	•	Iniciar sesión en https://www.linkedin.com.
	•	Completar los campos como se indica abajo.
...
Sección 'Acerca de' / About (copiar y pegar):
Soy historiador especializado en historia social latinoamericana, violencia empresarial, represión estatal y derechos humanos.
...
Docente en posgrado y grado en UBA. Columnista en El Cohete a la Luna y en Radio Nacional Rusia (corresponsal especial para Argentina). Jurado de tesis de maestría y árbitro de revistas académicas nacionales e internacionales.
...
Corresponsal especial · Radio Nacional Rusia · 2003 – presente

5.3 Educación
Doctor en Historia · Universidad de Buenos Aires · 2013-2021 · Sobresaliente con Recomendación de Publicación
Licenciado en Historia · Universidad de Buenos Aires · 2004-2011 · Promedio 9.00

5.4 Publicaciones destacadas
Agregar en la sección 'Publicaciones':
Jasinski, Alejandro (2023). El encanto del tanino. Buenos Aires: Prometeo. 310 pp. ISBN: 978-987-697-220-1
Jasinski, Alejandro (2013). Revuelta obrera y masacre en La Forestal. Buenos Aires: Biblos. 278 pp. ISBN: 978-987-691-157-5
Basualdo, V. (coord.) (2016). La responsabilidad empresarial en los delitos de lesa humanidad. Buenos Aires: Infojus/Ministerio de Justicia. 2 tomos, 1100 pp.
Jasinski, A. (2021). Informe histórico Masacre de Napalpí 1924. Buenos Aires: SDH, 250 pp.
Jasinski, A. y Basualdo, V. (2016). 'La represión a los trabajadores y el movimiento sindical, 1974-1983'. En Basualdo (coord.), La responsabilidad empresarial..., pp. 23-118.

5.5 Habilidades / Skills
Agregar en la sección 'Skills':
Historia Social · Historia de América Latina · Investigación Histórica · Derechos Humanos · Periodismo · Docencia universitaria · Archivos históricos · Historia oral

5.6 URL personalizada
	•	Ir a 'Editar perfil público y URL' (ícono del lápiz en la parte superior derecha del perfil).
	•	Personalizar la URL:
linkedin.com/in/alejandro-jasinski
💡 Si esa URL ya está tomada, intentar: alejandro-jasinski-historiador · jasinski-alejandro

5.7 Estrategia por audiencia
Para academia internacional:
Destacar publicaciones, estancias (Konstanz), participación en congresos internacionales y rol como evaluador de revistas.
Para organismos de DDHH y Estado:
Destacar el trabajo en la Secretaría de DDHH, los informes sobre Napalpí, Iván Torres Millacura y la Causa Ford.
Para periodismo y medios:
Destacar columnas en El Cohete a la Luna, corresponsalía en Radio Nacional Rusia y experiencia periodística.
Para editoriales y cultura:
...
Una vez que tengas los datos, avisame y los incorporo al CV Maestro.

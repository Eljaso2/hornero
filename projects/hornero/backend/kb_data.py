...
Autor: Gonzalo Pérez Álvarez. Fuente: Historia Obrera — Efemérides. Bibliografía: Iñigo Carrera y Cotarelo (2003), Bonnet (2002).""",
    ...
    {
        "id": "kb-efem-mercedes-1978",
        "tipo": "academico",
        "category": "efemeride",
        "tags": ["Mercedes-Benz", "1978", "huelga", "dictadura", "Proceso", "González Catán", "resistencia obrera", "primera huelga", "comisión interna", "CGT intervenida"],
        "title": "Efeméride: Huelga de Mercedes-Benz — 7 de agosto de 1978",
        "text": """HUELGA DE MERCEDES-BENZ — 7 DE AGOSTO DE 1978

El 7 de agosto de 1978, los obreros de la planta de Mercedes-Benz en González Catán, provincia de Buenos Aires, se declararon en huelga. Fue la primera huelga importante bajo la dictadura militar iniciada en marzo de 1976. Los trabajadores reclamaban contra la quita de un plus salarial y el incumplimiento de acuerdos. La huelga rompió dos años de silencio sindical impuesto por el terror.

La dictadura había intervenido la CGT, clausurado comisiones internas y secuestrado a dirigentes obreros. La huelga de Mercedes-Benz demostró que la clase trabajadora no estaba derrotada y abrió el camino para las luchas de 1979 y 1980 — las huelgas de Ford, los paros de la CGT Brasil — que minaron la dictadura desde adentro.

Autor: Hernán Oliveira. Fuente: Historia Obrera — Efemérides. Bibliografía: Oliveira (2019), Palomino (2006).""",
        "sources": ["historiaobrera.com.ar/efemerides", "Oliveira, Hernán — El sindicalismo argentino bajo la dictadura. Resistencia y reconstrucción", "Palomino, Héctor — Los trabajadores en la Argentina reciente"],
        "quotes": [],
        "grade_access": "open",
        "vigencia": "vigente",
        "image": "",
    ...
    {
        "id": "kb-efem-inquilinos-1907",
        "tipo": "academico",
        "category": "efemeride",
        "tags": ["huelga de inquilinos", "1907", "conventillos", "Buenos Aires", "Liga de Inquilinos", "alquileres", "mujeres", "resistencia popular", "inmigrantes", "Ley de Residencia"],
        "title": "Efeméride: Huelga de inquilinos de Buenos Aires — 14 de agosto de 1907",
        "text": """HUELGA DE INQUILINOS DE BUENOS AIRES — 14 DE AGOSTO DE 1907

En agosto de 1907, los inquilinos de los conventillos de Buenos Aires se negaron a pagar los aumentos de alquiler impuestos por los propietarios. Más de 100.000 personas — obreros, inmigrantes, mujeres y niños — se plegaron al boicot. Las mujeres fueron protagonistas centrales: organizaban asambleas en los patios de los conventillos, cerraban las puertas a los cobradores y enfrentaban a la policía.

La huelga se extendió a Rosario, Bahía Blanca y otras ciudades. La Liga de Inquilinos coordinó la resistencia con un programa que incluía la reducción de alquileres, mejoras en la vivienda y la regulación estatal. La represión policial y la Ley de Residencia (que permitía expulsar a extranjeros) debilitaron el movimiento, pero la huelga de 1907 quedó como un hito de la resistencia popular urbana y de la organización autónoma de la clase trabajadora.

Autor: Mirta Zaida Lobato. Fuente: Historia Obrera — Efemérides. Bibliografía: Lobato (2007), Cattaruzza (2004).""",
        "sources": ["historiaobrera.com.ar/efemerides", "Lobato, Mirta Zaida — Historia de los trabajadores en la Argentina", "Cattaruzza, Alejandro — Los inquilinos de Buenos Aires"],
        "quotes": [],
        "grade_access": "open",
        "vigencia": "vigente",
        "image": "",
...

    {
        ...
        "tipo": "academico",
        "category": "efemeride",
        "tags": ["Trelew", "1972", "masacre", "Rawson", "Lanusse", "Base Almirante Zar", "fuga", "presos políticos", "montoneros", "PRT-ERP", "FAR", "Camps", "Berger", "Haidar"],
        "title": "Efeméride: Masacre de Trelew — 22 de agosto de 1972",
        "text": """MASACRE DE TRELEW — 22 DE AGOSTO DE 1972

El 22 de agosto de 1972, 16 presos políticos fueron fusilados en la Base Naval Almirante Zar de Trelew, Chubut. Habían sido recapturados tras el intento de fuga del penal de Rawson del 15 de agosto — donde 6 dirigentes lograron escapar en un avión hacia Chile. Los 19 recapturados fueron trasladados a la base y ametrallados en sus celdas. Sobrevivieron tres: Alberto Camps, María Antonia Berger y René Haidar, que pudieron testimoniar y denunciar la masacre.

La versión oficial habló de "intento de fuga" — pero los sobrevivientes demostraron que fue un fusilamiento. La Masacre de Trelew destruyó la narrativa de "apertura política" de la dictadura de Lanusse y aceleró la radicalización de la resistencia popular. Entre los asesinados había militantes montoneros, del PRT-ERP y de las FAR — muchos de ellos obreros y dirigentes sindicales.

Autor: Laura Ortiz. Fuente: Historia Obrera — Efemérides. Bibliografía: Chévez (2012), Aguila (2013).""",
        "sources": ["historiaobrera.com.ar/efemerides", "Chévez, Eduardo — Trelew. La fuga que fue noticia", "Aguila, Gabriela — Trelew. Memorias de la masacre"],
        "quotes": [],
        "grade_access": "open",
        "vigencia": "vigente",
        "image": "https://upload.wikimedia.org/wikipedia/commons/6/6a/Trelew_Massacre_Memorial.jpg",
        "imageSource": "https://es.wikipedia.org/wiki/Masacre_de_Trelew",
    },

    {
        "id": "kb-efem-ford-1979",
        "tipo": "academico",
        "category": "efemeride",
        "tags": ["Ford", "1979", "huelga", "dictadura", "General Pacheco", "desaparición", "complicidad empresarial", "centro clandestino", "terrorismo de Estado", "violencia empresarial", "juicio oral"],
        "title": "Efeméride: Huelga de Ford Argentina — 28 de agosto de 1979",
        "text": """HUELGA DE FORD ARGENTINA — 28 DE AGOSTO DE 1979

En agosto de 1979, los obreros de la planta de Ford en General Pacheco, provincia de Buenos Aires, se declararon en huelga. Fue parte de la ola de luchas que siguió a la huelga de Mercedes-Benz de 1978. La empresa colaboró directamente con la dictadura: permitió que el Ejército montara un centro clandestino dentro de la planta y facilitó la identificación y secuestro de delegados y activistas. Al menos 24 trabajadores fueron secuestrados y torturados dentro de la fábrica.

El caso Ford se convirtió en un símbolo de la complicidad empresarial con el terrorismo de Estado. En 2019, la causa judicial llegó a juicio oral — uno de los primeros casos de violencia empresarial juzgados en Argentina. La huelga de Ford mostró que la clase obrera era una de las principales víctimas del terror dictatorial y que la resistencia sindical continuaba incluso bajo las condiciones más represivas.

Autor: Hernán Oliveira. Fuente: Historia Obrera — Efemérides. Bibliografía: Oliveira (2019), Garguin (2016).""",
        "sources": ["historiaobrera.com.ar/efemerides", "Oliveira, Hernán — El sindicalismo argentino bajo la dictadura", "Garguin, Enrique — Ford Argentina y la dictadura. Negocios y terrorismo de Estado"],
        "quotes": [],
        "grade_access": "open",
        "vigencia": "vigente",
        "image": "",

...
def get_greeting_hint(section: str, grade: str = 'A', days_since_last_chat: int = 999, incoming_reports_count: int = 0) -> str:
    ...
    greetings = {
        ...
        'historia': 'Saluda brevemente (2-3 líneas). Di que sos historiadora del movimiento obrero argentino — conoces La Forestal, las masacres, los lockouts, los referentes que nadie recuerda. Contá qué se puede recorrer en la sección: efemérides, Mitín (ensayos de historia obrera), Colección La Argentina Peronista, Retazos (docuficción, audio, ilustraciones, música). Preguntá qué tema histórico quiere explorar. NO cites datos, NO列举 eventos, NO quotes en el saludo. MODO CHARLA — {"sections": [{"title": "¡Hola! Soy la Historiadora", "body": "..."}], "tags": ["historia", "saludo"]}',

        'panorama': 'Saluda brevemente (2-3 líneas). Di que sos investigador/a de la clase obrera — estudiás cómo se forma la clase trabajadora, qué la compone, qué la daña y qué la sostiene. Preguntá qué quiere explorar. NO cites datos, NO列举 índices, NO expliques todo. Solo saludá + quién sos + una pregunta. MODO CHARLA — {"sections": [{"title": "¡Hola! Soy la Investigadora", "body": "..."}], "tags": ["panorama", "saludo"]}',

...
MD_PATH = os.path.join(os.path.dirname(__file__), "..", "..", "biblioteca", "rag", "prensa-sindical", "SIPREBA-guia-delegado", "2024-guia-del-delegado-sipreba.md")
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), "..", "..", "biblioteca", "rag", "prensa-sindical", "SIPREBA-guia-delegado", "sipreba-guia-delegado.chunks.json")

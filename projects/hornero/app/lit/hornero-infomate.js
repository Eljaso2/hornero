...
class HorneroInfomate extends HoComponent {
    ...
    const cintilloHtml = '<div class="act-cintillo">' +
      ...
      '<div class="chat-plus-wrapper">' +
        ...
        (this._plusMenuOpen ? '<div class="chat-plus-menu" id="matePlusMenu">' +
          '<button class="chat-plus-menu-close" id="mateMenuCloseBtn" title="Cerrar"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="6" y1="6" x2="18" y2="18"/><line x1="18" y1="6" x2="6" y2="18"/></svg></button>' +
  ...
  _afterRender() {
    ...
    const mateMenuCloseBtn = this.shadowRoot.querySelector('#mateMenuCloseBtn');
    if (mateMenuCloseBtn) {
      mateMenuCloseBtn.addEventListener('click', () => {

  ...
  _styles() {
    return css`
      ...
      .share-menu-title { font-family: 'Archivo', sans-serif; font-weight: 700;
        font-size: .92rem; color: var(--ho-text, #E8E6E0); margin-bottom: 16px;
        text-align: center; }
      .share-menu-icons { display: flex; justify-content: center; gap: 16px; }
      .share-menu-icon-btn { width: 48px; height: 48px; border-radius: 50%;
        background: none; border: 1px solid var(--ho-border, rgba(255,255,255,.1));
        cursor: pointer; display: flex; align-items: center; justify-content: center;
        transition: background .2s, border-color .2s, transform .15s; }
      .share-menu-icon-btn:hover { background: var(--ho-green-pale, #E0F0EB);
        border-color: var(--ho-green-light, #80CCA0); transform: scale(1.08); }
      .share-menu-icon-btn svg { width: 24px; height: 24px; }
      .share-menu-icon-btn .icon-emoji { font-size: 1.4rem; line-height: 1; }
      .share-menu-cancel { display: block; margin-top: 14px; padding: 8px;
      ...
      .history-item-persona-img { width: 100%; height: 100%; object-fit: cover; object-position: center 50%; }
      .history-item-persona-img.periodista-full { object-fit: cover; object-position: center 50%; }
      .history-item-persona-img.abogado-crop { object-position: center 55%; }
      .history-item-persona-img.investigador-crop { object-position: center 45%; }
      ...
      .msg-avatar img.periodista-full { object-fit: cover; object-position: center 50%; }
      .msg-avatar img.abogado-crop { object-position: center 55%; }
      .msg-avatar img.investigador-crop { object-position: center 45%; }
      ...
      .persona-icon-inner img { width: 100%; height: 100%; object-fit: cover;
        object-position: center 50%; filter: var(--ho-persona-filter, none); }
      .persona-icon-inner img.periodista-full { object-fit: cover; object-position: center 50%; }
      .persona-icon-inner img.abogado-crop { object-position: center 55%; }
      .persona-icon-inner img.investigador-crop { object-position: center 45%; }
      ...
      .msg-redirect-icon-circle img { width: 22px; height: 22px; object-fit: cover; object-position: center 50%;
        filter: var(--ho-persona-filter, none); }
      .msg-redirect-icon-circle img.periodista-full { object-fit: cover; object-position: center 50%; }
      .msg-redirect-icon-circle img.abogado-crop { object-position: center 55%; }
      .msg-redirect-icon-circle img.investigador-crop { object-position: center 45%; }
      ...
      .typing-avatar { width: 32px; height: 32px;
        display: flex; align-items: center; justify-content: center; flex: none; }
      .typing-avatar img { width: 32px; height: 32px; object-fit: cover; object-position: center 50%;
        filter: var(--ho-persona-filter, none); }
      .typing-avatar img.periodista-full { object-fit: cover; object-position: center 50%; }
      .typing-avatar img.abogado-crop { object-position: center 55%; }
      .typing-avatar img.investigador-crop { object-position: center 45%; }
...
<footer>Exportado de Hornero</footer>
  ...
  _showShareMenu(msgIndex) {
    ...
    overlay.innerHTML = `
      <div class="share-menu">
        ...
        <div class="share-menu-icons">
          <button class="share-menu-icon-btn" data-share-action="whatsapp" title="WhatsApp">
          ...
          <button class="share-menu-icon-btn" data-share-action="email" title="Email">
            <svg viewBox="0 0 24 24" fill="none" stroke="var(--ho-text, #E8E6E0)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
          </button>
          <button class="share-menu-icon-btn" data-share-action="copy" title="Copiar texto">
            <svg viewBox="0 0 24 24" fill="none" stroke="var(--ho-text, #E8E6E0)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg>
          </button>
        </div>
    ...
    overlay.querySelectorAll('.share-menu-icon-btn').forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        if (shareAction === 'whatsapp') {
          ...
          navigator.clipboard.writeText(txtContent).then(() => {
            this._showDownloadToast('Texto copiado');
          }).catch(() => {

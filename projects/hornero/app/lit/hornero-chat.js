  ...
  _styles() {
    return css`
      ...
      .chat-persona-icon.active .persona-icon-inner { background: var(--ho-green-pale, #E0F0EB);
        border-color: var(--ho-green-light, #80CCA0); }
      .chat-persona-icon .persona-cintillo-label { font-family: 'Archivo', sans-serif; display: none;
        font-size: .52rem; font-weight: 600; color: var(--ho-text-mid, #6E6A60);
        writing-mode: vertical-rl; text-orientation: mixed;
        max-height: 36px; overflow: hidden; transition: color .2s, filter .3s; }
      ...
      .msg-text { font-family: 'Public Sans', sans-serif; font-size: 1.14rem;
      ...
      .msg-md-code { font-family: 'JetBrains Mono', monospace; font-size: .97rem;
      ...
      .msg-section-title { font-family: 'Public Sans', sans-serif; font-weight: 400;
        font-size: 1.12rem; color: var(--ho-text, #E8E6E0); margin-bottom: 6px; }
      .msg-section-body { font-family: 'Public Sans', sans-serif; font-size: 1.10rem;
      ...
      .chat-input-field { flex: 1; background: var(--ho-card, #2A3230);
        border: 1px solid var(--ho-border, rgba(255,255,255,.08));
        border-radius: 22px; padding: 6px 14px; font-size: 1.12rem;

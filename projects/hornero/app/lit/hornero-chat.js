...
class HorneroChat extends HoComponent {
  ...
  _styles() {
    return css`
      ...
      .history-item-persona-img { width: 100%; height: 100%; object-fit: cover; object-position: center 40%; transform: scale(1.1); }
      .history-item-persona-img.periodista-full { object-fit: cover; object-position: center 40%; }
      .history-item-persona-img.abogado-crop { object-position: center 45%; }
      .history-item-persona-img.investigador-crop { object-position: center 35%; }
      ...
      .msg-avatar img.periodista-full { object-fit: cover; object-position: center 40%; }
      .msg-avatar img.abogado-crop { object-position: center 45%; }
      .msg-avatar img.investigador-crop { object-position: center 35%; }
      ...
      .persona-icon-inner img { width: 100%; height: 100%; object-fit: cover;
        ...
        transform: scale(1.1);
        filter: var(--ho-persona-filter, none); }
      .persona-icon-inner img.periodista-full { object-fit: cover; object-position: center 40%; }
      .persona-icon-inner img.abogado-crop { object-position: center 45%; }
      .persona-icon-inner img.investigador-crop { object-position: center 35%; }
      ...
      .msg-redirect-icon-circle img { width: 22px; height: 22px; object-fit: cover; object-position: center 40%;
        transform: scale(1.1);
        filter: var(--ho-persona-filter, none); }
      .msg-redirect-icon-circle img.periodista-full { object-fit: cover; object-position: center 40%; }
      .msg-redirect-icon-circle img.abogado-crop { object-position: center 45%; }
      .msg-redirect-icon-circle img.investigador-crop { object-position: center 35%; }
      ...
      .typing-avatar { width: 32px; height: 32px;
        display: flex; align-items: center; justify-content: center; flex: none; }
      .typing-avatar img { width: 32px; height: 32px; object-fit: cover; object-position: center 40%;
        transform: scale(1.1);
        filter: var(--ho-persona-filter, none); }
      .typing-avatar img.periodista-full { object-fit: cover; object-position: center 40%; }
      .typing-avatar img.abogado-crop { object-position: center 45%; }
      .typing-avatar img.investigador-crop { object-position: center 35%; }

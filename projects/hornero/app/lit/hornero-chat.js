...
class HorneroChat extends HoComponent {
  ...
  _styles() {
    return css`
      ...
      .history-item-persona-img { width: 100%; height: 100%; object-fit: cover; object-position: center 30%; transform: scale(2.0); }
      .history-item-persona-img.periodista-full { object-fit: cover; object-position: center 30%; }
      .history-item-persona-img.abogado-crop { object-position: center 25%; }
      .history-item-persona-img.investigador-crop { object-position: center 25%; }
      ...
      .msg-avatar img.periodista-full { object-fit: cover; object-position: center 30%; }
      .msg-avatar img.abogado-crop { object-position: center 25%; }
      .msg-avatar img.investigador-crop { object-position: center 25%; }
      ...
      .persona-icon-inner img { width: 100%; height: 100%; object-fit: cover;
        ...
        transform: scale(2.0);
        filter: var(--ho-persona-filter, none); }
      .persona-icon-inner img.periodista-full { object-fit: cover; object-position: center 30%; }
      .persona-icon-inner img.abogado-crop { object-position: center 25%; }
      .persona-icon-inner img.investigador-crop { object-position: center 25%; }
      ...
      .msg-redirect-icon-circle img { width: 22px; height: 22px; object-fit: cover; object-position: center 30%;
        transform: scale(2.0);
        filter: var(--ho-persona-filter, none); }
      .msg-redirect-icon-circle img.periodista-full { object-fit: cover; object-position: center 30%; }
      .msg-redirect-icon-circle img.abogado-crop { object-position: center 25%; }
      .msg-redirect-icon-circle img.investigador-crop { object-position: center 25%; }
      ...
      .typing-avatar { width: 32px; height: 32px;
        display: flex; align-items: center; justify-content: center; flex: none; }
      .typing-avatar img { width: 32px; height: 32px; object-fit: cover; object-position: center 30%;
        transform: scale(2.0);
        filter: var(--ho-persona-filter, none); }
      .typing-avatar img.periodista-full { object-fit: cover; object-position: center 30%; }
      .typing-avatar img.abogado-crop { object-position: center 25%; }
      .typing-avatar img.investigador-crop { object-position: center 25%; }

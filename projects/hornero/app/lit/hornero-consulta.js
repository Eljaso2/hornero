...
class HorneroConsulta extends HoComponent {
  ...
  _localResponse(userText, errDetail) {
    ...
    if (lower.includes('yofra')) {
      return { role: 'hornero', text: 'Yofra es el Secretario General de la Federación Aceitera — lleva años peleando la paritaria y organizando la resistencia. Dice que "organizar es construir" y que no hay milagro sindical — hay trabajo, reunión, asamblea y debate (Ciclo "Por las hendijas del Quebracho", enero 2021).\n\n¿Te interesa algo legal en particular? ¿Paritaria, convenio, algún reclamo?', tags: ['yofra', 'consulta'], persona: p, time: this._timeNow() };
    }

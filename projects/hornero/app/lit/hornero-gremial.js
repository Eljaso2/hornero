    ...
    return html`
      ...
      <div class="chat-container">
        <hornero-chat
          ...
          grade="${this.grade}"
          section-info='{"title":"Reporte Gremial","bajada":"El Compañero te ayuda a armar reportes gremiales paso a paso: primero contás la situación, luego se clasifica, podés hacer seguimiento y finalmente se aprueba el informe. Todo es confidencial.","explore":["Relato","Clasificación","Seguimiento","Aprobación"]}'
        ></hornero-chat>
      </div>
